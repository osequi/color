// https://github.com/BuiltByEdgar/basic-javascript-knob
...
(function() {
    ...
    */
    ...
    Knob = function( container, output )
    {
        ...
        this.lineWidth = this.canvas.width / 7;
        ...
        this.startAngle = 2.9 * Math.PI + this.angleOffset; // 2.9
    ...
    Knob.prototype.draw = function( mouseX, mouseY )
    {
        ...
        this.context.arc( this.knobX, this.knobY, this.radius, 82, 650, 1, false );
...
var knob = new Knob( 'drag-dial__control', 'drag-dial__value' );
